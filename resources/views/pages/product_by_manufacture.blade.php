        ...
        <div class="col-sm-9 padding-right">
            ...
            <div class="category-tab"><!--category-tab-->
                <div class="col-sm-12">
                    <ul class="nav nav-tabs">
                        ...
                        $all_published_manufacture=DB::table('tbl_manufacture')
                            ...
                            ->get();
                        foreach ($all_published_manufacture as $v_manufacture) {?>
                        <li class="{{Request::is('product_by_manufacture/'.$v_manufacture->manufacture_id)?'active':''}}">
                            <a href="{{URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)}}">
                                <span class="pull-right">(50)</span>
                                {{$v_manufacture->manufacture_name}}
                            </a>
                        </li>
                        <?php } ?>
                    </ul>
                ...
                <div class="tab-content">
                    <?php foreach ($product_by_manufacture as $V_product_by_category) {?>
                    <div class="col-sm-4">
                        <div class="product-image-wrapper">
                            <div class="single-products">
                                <div class="productinfo text-center">
                                    <img src="{{URL::to($V_product_by_category->product_image)}}"
                                         style="width: 200px;height: 300px" alt="Image Missing" />
                                ...
                                <div class="product-overlay">
                                    <div class="overlay-content">
                                        <h2>{{$V_product_by_category->product_price}}</h2>
                                        <a href="{{URL::to('/view_product/'.$V_product_by_category->product_id)}}">
                                            <p>{{$V_product_by_category->product_name}}</p>
                                        </a>
                            ...
                            <div class="choose">
                                <ul class="nav nav-pills nav-justified">
                                    <li><a href="{{URL::to('/view_product/'.$V_product_by_category->product_id)}}"><i class="fa fa-plus-square"></i>{{$V_product_by_category->manufacture_name}}</a></li>
